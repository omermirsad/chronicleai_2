...
const JournalEditor = lazy(() => import('./src/components/JournalEditor'));
const JournalFeed = lazy(() => import('./src/components/JournalFeed'));
const InsightsView = lazy(() => import('./src/components/InsightsView'));
const CalendarView = lazy(() => import('./src/components/CalendarView'));
const PerspectiveLensModal = lazy(() => import('./src/components/PerspectiveLensModal'));
