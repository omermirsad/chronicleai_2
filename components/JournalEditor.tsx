...
const JournalEditor: FC<JournalEditorProps> = ({ addEntry, updateEntry, setCurrentView, userId }) => {
  ...
  const handleSaveGuidedSession = async () => {
     ...
     try {
        ...
        console.error("Failed to get AI analysis for guided session:", error);
     } finally {
