...
export const useJournal = () => {
  ...
  const addEntry = async (newEntryData: Omit<JournalEntry, 'id' | 'createdAt' | 'updatedAt'>) => {
    ...
    try {
      ...
      toast('Entry saved offline, will sync when connected.', { icon: 'ℹ️' });
    }
  };
  ...
  const updateEntry = async (id: string, updates: Partial<JournalEntry>) => {
    ...
    try {
      ...
      toast('Update saved offline, will sync when connected.', { icon: 'ℹ️' });
    }
  };
  ...
  const deleteEntry = async (id: string) => {
    ...
    try {
      ...
      toast('Delete saved offline, will sync when connected.', { icon: 'ℹ️' });
    }
  };
